...
class GaussianModel:
    def __init__(self, xyz=None, opacity=None, rotation=None, scaling=None, shs=None, offset=None, ply_path=None, sh2rgb=False) -> None:
        ...
        self._opacity = torch.empty(0)  # Add _opacity attribute like Gaussian Head  
        
        # Add Gaussian Head style features (like pc._features_dc, pc._features_rest)
    ...
    def get_opacity(self):
        return self._opacity  # Return directly since TriPlane already applies sigmoid 
