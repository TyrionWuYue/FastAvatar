...
from VGGTAvatar.models.transformer import TransformerDecoder
...
import VGGTAvatar.models.rendering.utils.mesh_utils as mesh_utils
from VGGTAvatar.models.rendering.utils.point_utils import depth_to_normal
    ...
    def __init__(self, query_dim, context_dim, num_heads, mlp=False, decode_with_extra_info=None):
        ...
        if decode_with_extra_info is not None:
            if decode_with_extra_info["type"] == "dinov2p14_feat":
                ...
                from VGGTAvatar.models.encoders.dinov2_wrapper import Dinov2Wrapper
                ...
                from VGGTAvatar.models.encoders.xunet_wrapper import XnetWrapper
...
def test_head():
    ...
    from VGGTAvatar.datasets.video_head import VideoHeadDataset
